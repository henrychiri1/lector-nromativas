...
# Cambia esta clave por algo que solo tú sepas
...
with col2:
    if os.path.exists("logo.jpeg"):
        ...
        st.markdown("<h4 style='text-align: center; color: #1f77b4;'>Aval oficial F.D.M.E.R.C.</h4>", unsafe_allow_html=True)
...
if st.session_state.audio_a_reproducir and os.path.exists(st.session_state.audio_a_reproducir):
    ...
    # Reproductor HTML sin botón de descarga nativo
    st.markdown(f'''
...
if os.path.exists(ruta_audios):
    ...
    st.warning("No hay audios cargados en la carpeta /audios")
